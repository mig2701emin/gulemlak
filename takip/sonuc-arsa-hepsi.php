<?php
    ...
    header("location: login.php");
 	...
 	if($_GET["grupno"]){
		$sorgu=mysql_query("update satilik_arsa set grup='".$_GET["grupno"]."' where id='".$_GET["ilanid"]."'");
		}
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select satilik_arsa.id,satilik_arsa.mahalle_id,satilik_arsa.ada,satilik_arsa.parsel,satilik_arsa.imar_durumu,satilik_arsa.m2,satilik_arsa.tapu_durumu,satilik_arsa.fiyat,satilik_arsa.sahip_isim,satilik_arsa.sahip_numara,satilik_arsa.grup,satilik_arsa.ekleyen,satilik_arsa.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_arsa LEFT JOIN mahalle_koy ON satilik_arsa.mahalle_id=mahalle_koy.MAH_ID where durum=1");
							}else{
								$sorgu=mysql_query("select satilik_arsa.id,satilik_arsa.mahalle_id,satilik_arsa.ada,satilik_arsa.parsel,satilik_arsa.imar_durumu,satilik_arsa.m2,satilik_arsa.tapu_durumu,satilik_arsa.fiyat,satilik_arsa.sahip_isim,satilik_arsa.sahip_numara,satilik_arsa.grup,satilik_arsa.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_arsa LEFT JOIN mahalle_koy ON satilik_arsa.mahalle_id=mahalle_koy.MAH_ID where durum=1 AND uye_id='".$_SESSION["uye_id"]."'");
							}
									$sil=$_POST["sil"];
						...
						<tr>
						  ...
						  <td><?php echo $row["imar_durumu"]?></td>
						  <td><?php echo $row["m2"]."m<sup>2</sup>"?></td>
						  <td><?php echo $row["tapu_durumu"]?></td>
						  ...
						  <div id="butt">
                            ...
                            <a href="arsa-guncelle.php?id=<?php echo $row["id"]; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
							<a href="sil.php?idarsa=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil</a>
                      <!----------------------------------------------------------------------------------------------------------->
                                <div>
                                  <select  name="grup"   class="<?php if ($row["grup"]==0){?>text-danger<?php }?>" onchange="ilan_grup_degistir('sonuc-arsa-hepsi.php',this.options[selectedIndex].value,<?=$row["id"];?>);">
