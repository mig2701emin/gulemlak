<?php
	...
	if($_GET["grupno"]){
		$sorgu=mysql_query("update satilik_isyeri set grup='".$_GET["grupno"]."' where id='".$_GET["ilanid"]."'");
		}
?>
        ...
        <div class="right_col" role="main">
            <div id="editt" class="page-title">
              <div class="title_left">
                <h3>Satılık <small>İşyerleri</small></h3>
              </div>
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select satilik_isyeri.id,satilik_isyeri.mahalle_id,satilik_isyeri.apartman,satilik_isyeri.kat,satilik_isyeri.kapi_no,satilik_isyeri.oda,satilik_isyeri.mkare,satilik_isyeri.cephe,satilik_isyeri.fiyat,satilik_isyeri.sahip_isim,satilik_isyeri.sahip_numara,satilik_isyeri.grup,satilik_isyeri.ekleyen,satilik_isyeri.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_isyeri LEFT JOIN mahalle_koy ON satilik_isyeri.mahalle_id=mahalle_koy.MAH_ID where durum=1");
							}else{
								$sorgu=mysql_query("select satilik_isyeri.id,satilik_isyeri.mahalle_id,satilik_isyeri.apartman,satilik_isyeri.kat,satilik_isyeri.kapi_no,satilik_isyeri.oda,satilik_isyeri.mkare,satilik_isyeri.cephe,satilik_isyeri.fiyat,satilik_isyeri.sahip_isim,satilik_isyeri.sahip_numara,satilik_isyeri.grup,satilik_isyeri.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_isyeri LEFT JOIN mahalle_koy ON satilik_isyeri.mahalle_id=mahalle_koy.MAH_ID where durum=1 AND uye_id='".$_SESSION["uye_id"]."'");
							}
									$sil=$_POST["sil"];
						...
						<tr>
						  ...
						  <div id="butt">
                            ...
                            <a href="is-yeri-guncelle.php?id=<?php echo $row["id"]; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
                            <a href="sil.php?idsatisyeri=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil </a>
                      <!----------------------------------------------------------------------------------------------------------->
                                <div>
                                  <select  name="grup"   class="<?php if ($row["grup"]==0){?>text-danger<?php }?>" onchange="ilan_grup_degistir('sonuc-is-yeri-sat-hepsi.php',this.options[selectedIndex].value,<?=$row["id"];?>);">
