                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
								...
								$sorgu=mysql_query("SELECT * FROM yonetici WHERE durum=0 AND yonetici_id NOT IN (1) ");
						...
						<tr>
						  <td><?php echo $row["yonetici_ad_soyad"]?></td>
                          <td><?php echo $row["yonetici_kullanici"]?></td>
						  <td><?php echo $row["yonetici_email"]?></td>
						  <td><?php echo $row["yonetici_telefon"]?></td>
						  <td><?php echo $row["yonetici_son_giris"]?></td>
						  
						  <td id="salih">
						  <div id="butt">
                            
                            <a href="uye-guncelle.php?id=<?php echo $row["yonetici_id"]; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
							<a href="sil.php?idsiluye=<?php echo $row["yonetici_id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil</a>
						  </div>
                          </td>
