<?php 	
    ...
    header("location: login.php");
		...
		$sor=mysql_query("select * from kiralik-isyeri where id='$id'");
...
if($_SERVER['REQUEST_METHOD']=='POST'){	
		...
		if(!empty($apartman)){
				$daire_ekle=mysql_query("UPDATE kiralik_isyeri SET
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >İşyerinin Sahibinin Adı ve Soyadı <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >İşyerinin Sahibinin Numarası <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
