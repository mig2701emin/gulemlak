                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select satilik_daire.id,satilik_daire.mahalle_id,satilik_daire.apartman,satilik_daire.kat,satilik_daire.kapi_no,satilik_daire.oda,satilik_daire.mkare,satilik_daire.cephe,satilik_daire.fiyat,satilik_daire.sahip_isim,satilik_daire.sahip_numara,satilik_daire.grup,satilik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_daire LEFT JOIN mahalle_koy ON satilik_daire.mahalle_id=mahalle_koy.MAH_ID where grup='$grp' and durum=1");
							}else{
								$sorgu=mysql_query("select satilik_daire.id,satilik_daire.mahalle_id,satilik_daire.apartman,satilik_daire.kat,satilik_daire.kapi_no,satilik_daire.oda,satilik_daire.mkare,satilik_daire.cephe,satilik_daire.fiyat,satilik_daire.sahip_isim,satilik_daire.sahip_numara,satilik_daire.grup,satilik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_daire LEFT JOIN mahalle_koy ON satilik_daire.mahalle_id=mahalle_koy.MAH_ID where grup='$grp' and durum=1 AND uye_id='".$_SESSION["uye_id"]."'");
							}
									$sil=$_POST["sil"];
