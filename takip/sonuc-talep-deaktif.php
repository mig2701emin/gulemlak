                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						<tr>
						  ...
						  <th>Numara</th>
						  <th><div style="width:%5;">Talep</div></th>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select * from talepler where durum=0");
							}else{
								$sorgu=mysql_query("select * from talepler where durum=0 AND uye_id='".$_SESSION["uye_id"]."'");
							}		
									$sil=$_POST["sil"];
						...
						<tr>
                          ...
                          <td><?php echo $row["talep"]; ?></td>

						  <td id="salih">
						  <div id="butt">
                            
                            <a href="talep-guncelle.php?id=<?php echo $row["id"]; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
							<a href="sil.php?idtalepaktif=<?php echo $row["id"]; ?>" class="btn btn-info btn-xs"><i class="fa fa-trash-o"></i> Geri Al </a>
							<a href="sil.php?idtalepsil=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil</a>
						  </div>
                          </td>
