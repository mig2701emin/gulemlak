...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if(!empty($isim)){
				...
				$talep_ekle=mysql_query("INSERT INTO rehber SET
								 ...
								 info				=	'$info',
								 uye_id				=	'$uyeId'");
				header("location:rehber-ekle.php");
		}else{
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="tel"  class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label  class="control-label col-md-3">Bölge</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="bolge"  class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
