...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($durum==satilik){
			$ilanid=$bul['Auto_increment'];
				...
				$daire_ekle=mysql_query("INSERT INTO satilik_isyeri SET
								 ...
								 sahip_numara		=	'$sahip_numara',
								 uye_id				=	'".$_SESSION["uye_id"]."',
								 ekleyen			=	'".$_SESSION["name"]."',
								 durum				=	1");
					header("location:is-yeri-ekle.php");
		}elseif($durum==kiralik){
			$ilanid=$bul1['Auto_increment'];
				$daire_ekle=mysql_query("INSERT INTO kiralik_isyeri SET
								 mahalle_id			=	'$mahalleid',
								 apartman			=	'$apartman',
								 kat				=	'$kat',
								 kapi_no			=	'$kapi',
	...
	if(empty($resimurl)){
		...
		if($ekle){
			...
			header("refresh:2;url=is-yeri-ekle.php");
		}
	}
}
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="apartman"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="kapi" class="form-control col-md-7 col-xs-12">
									<option value="0">Kapı Numarası Seçiniz...</option>
						<?php
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="mkare" class="form-control col-md-7 col-xs-12">
									<option value="0">Metre Kare Seçiniz...</option>
						<?php
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="oda" class="form-control col-md-7 col-xs-12">
								<option value="0">Oda Sayısı Seçiniz...</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="cephe" class="form-control col-md-7 col-xs-12">
								<option value="0">Cephe Seçiniz...</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="fiyat" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <!-- <input  type="text" name="sahip_isim" class="form-control col-md-7 col-xs-12">-->
                          <!-------------------------------------------------------------------------------------->
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="sahip_numara" id="sahip_numara" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Durum <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select  name="durum"   class="form-control col-md-7 col-xs-12">
