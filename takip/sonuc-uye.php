                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
								...
								$sorgu=mysql_query("SELECT * FROM yonetici WHERE durum=1 AND yonetici_id NOT IN (1) ");
						...
						<tr>
						  ...
						  <div id="butt">
							...
							<a href="sil.php?iduye=<?php echo $row["yonetici_id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil</a>
						  </div>
                          </td>
