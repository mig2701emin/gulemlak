<?php 	
    ...
    header("location: login.php");
		...
		$sor=mysql_query("SELECT * FROM yonetici WHERE yonetici_id='$id'");
...
if($_SERVER['REQUEST_METHOD']=='POST'){	
		...
		if(!empty($fiyat)){
				$arsa_ekle=mysql_query("update yonetici SET
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left" method="POST" action="" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="uye_kullanici" value="<?php echo $getir['yonetici_kullanici']; ?>"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="password" name="uye_sifre"  value="<?php echo $getir['yonetici_sifre']; ?>" class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="password" name="sifre_tekrar"  value="<?php echo $getir['yonetici_sifre']; ?>" class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
