...
if($_SERVER['REQUEST_METHOD']=='POST'){	
		...
		if(!empty($fiyat)){
			$ilanid=$bul['Auto_increment'];
				$arsa_ekle=mysql_query("INSERT INTO satilik_arsa SET
								 ...
								 durum				=	1");
						header("location:arsa-ekle.php");
		}else{
			echo "<script>alert('Lütfen Alanları Doldurunuz')</script>";
		}	
	...
	if(empty($resimurl)){
		...
		if($ekle){
			...
			header("refresh:2;url=arsa-ekle.php");
		}
	}   
}
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="ada"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="parsel"   class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="imar"  class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="tapu"  class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
					  <div class="item form-group">
					  ...
					  <div class="item form-group">
					   ...
					   <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Grup <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select  name="grup"   class="form-control col-md-7 col-xs-12">
								<option value="1">Lütfen Grup Seçiniz...</option>
					<?php
