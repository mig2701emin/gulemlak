        ...
        <div class="right_col" role="main">
            <div id="editt" class="page-title">
              <div class="title_left">
                <h3>Silinen <small>Kiralık Daireler</small></h3>
              </div>
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select kiralik_daire.id,kiralik_daire.mahalle_id,kiralik_daire.apartman,kiralik_daire.kat,kiralik_daire.kapi_no,kiralik_daire.oda,kiralik_daire.mkare,kiralik_daire.cephe,kiralik_daire.fiyat,kiralik_daire.sahip_isim,kiralik_daire.sahip_numara,kiralik_daire.grup,kiralik_daire.ekleyen,kiralik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from kiralik_daire LEFT JOIN mahalle_koy ON kiralik_daire.mahalle_id=mahalle_koy.MAH_ID where durum=0");
							}else{
								$sorgu=mysql_query("select kiralik_daire.id,kiralik_daire.mahalle_id,kiralik_daire.apartman,kiralik_daire.kat,kiralik_daire.kapi_no,kiralik_daire.oda,kiralik_daire.mkare,kiralik_daire.cephe,kiralik_daire.fiyat,kiralik_daire.sahip_isim,kiralik_daire.sahip_numara,kiralik_daire.grup,kiralik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from kiralik_daire LEFT JOIN mahalle_koy ON kiralik_daire.mahalle_id=mahalle_koy.MAH_ID where durum=0 AND uye_id='".$_SESSION["uye_id"]."'");
							}		
									$sil=$_POST["sil"];
						...
						<tr>
						  ...
						  <div id="butt">
							...
							<a href="sil.php?idkira2=<?php echo $row["id"]; ?>" class="btn btn-info btn-xs"><i class="fa fa-trash-o"></i> Geri Al </a>
							<a href="sil.php?idsilkira=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil </a>
						  </div>
                          </td>
