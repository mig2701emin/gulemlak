...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if(!empty($grup)){
				$arsa_ekle=mysql_query("update gruplar SET grup	= '$grup' where id='$gid'");
    ...
    <div class="container body">
      <div class="main_container">
                  ...
                  <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Gruplar <span class="required">*</span>
                        </label>
		...
		<div class="item form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Grup Adı <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
