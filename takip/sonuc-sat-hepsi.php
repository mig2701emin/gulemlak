<?php
	...
	if($_GET["grupno"]){
		$sorgu=mysql_query("update satilik_daire set grup='".$_GET["grupno"]."' where id='".$_GET["ilanid"]."'");
		}
        ...
        <div class="right_col" role="main">
            <div id="editt" class="page-title">
              <div class="title_left">
                <h3>Satılık <small>Daireler</small></h3>
              </div>
            ...
            <div class="clearfix"></div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive wrap" cellspacing="0" width="100%">
                      <thead>
						<tr>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select satilik_daire.id,satilik_daire.mahalle_id,satilik_daire.apartman,satilik_daire.kat,satilik_daire.kapi_no,satilik_daire.oda,satilik_daire.mkare,satilik_daire.cephe,satilik_daire.fiyat,satilik_daire.sahip_isim,satilik_daire.sahip_numara,satilik_daire.grup,satilik_daire.ekleyen,satilik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_daire LEFT JOIN mahalle_koy ON satilik_daire.mahalle_id=mahalle_koy.MAH_ID where durum=1");
							}else{
								$sorgu=mysql_query("select satilik_daire.id,satilik_daire.mahalle_id,satilik_daire.apartman,satilik_daire.kat,satilik_daire.kapi_no,satilik_daire.oda,satilik_daire.mkare,satilik_daire.cephe,satilik_daire.fiyat,satilik_daire.sahip_isim,satilik_daire.sahip_numara,satilik_daire.grup,satilik_daire.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from satilik_daire LEFT JOIN mahalle_koy ON satilik_daire.mahalle_id=mahalle_koy.MAH_ID where durum=1 AND uye_id='".$_SESSION["uye_id"]."'");
							}		
									$sil=$_POST["sil"];
						...
						<tr>
						  ...
						  <div id="butt">
                            ...
                            <a href="daire-guncelle-sat.php?id=<?php echo $row["id"]; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Düzenle </a>
                            <a href="sil.php?idsat=<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil</a>
                      <!----------------------------------------------------------------------------------------------------------->
                                <div>
                                  <select  name="grup"   class="<?php if ($row["grup"]==0){?>text-danger<?php }?>" onchange="ilan_grup_degistir('sonuc-sat-hepsi.php',this.options[selectedIndex].value,<?=$row["id"];?>);">
