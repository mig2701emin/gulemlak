<?php 	
	...
	$sor=mysql_query("SELECT * FROM yonetici");
...
if($_SERVER['REQUEST_METHOD']=='POST'){	
		...
		$password			= $_POST['uye_sifre'];
		$password2			= $_POST['sifre_tekrar'];
		...
		if(empty($isim_soyisim) || empty($username) || empty($password) || empty($password2)){
			echo "<script>alert('Lütfen * İşareti Olan Alanları Doldurunuz'); window.location='uye-ekle.php';</script>";
		}elseif($password != $password2){
			echo "<script>alert('Şifreler Birbirini Tutmuyor'); window.location='uye-ekle.php';</script>";
			
		}else{
			
				$uye_ekle=mysql_query("INSERT INTO yonetici SET
								 yonetici_ad_soyad		=	'$isim_soyisim',
								 yonetici_kullanici		=	'$username',
								 yonetici_sifre			=	'$password',
								 yonetici_email			=	'$email',
								 yonetici_telefon		=	'$telefon',
								 durum					=	1");
						echo "<script>alert('Üye Başarı ile Eklendi'); window.location='uye-ekle.php';</script>";
		}	
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="uye_ad_soyad"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="uye_kullanici"   class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Şifre Tekrar <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="uye_email"  class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
                      <div class="item form-group">
                        <label  class="control-label col-md-3 col-sm-3 col-xs-12">Telefon</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="uye_telefon"  class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div>
