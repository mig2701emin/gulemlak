        ...
        <div class="right_col" role="main">
            <div id="editt" class="page-title">
              <div class="title_left">
                <h3>Kiralık <small>İşyerleri</small></h3>
              </div>
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
						...
						<?php  
							if($_SESSION["uye_id"] == 1){								
								$sorgu=mysql_query("select kiralik_isyeri.id,kiralik_isyeri.mahalle_id,kiralik_isyeri.apartman,kiralik_isyeri.kat,kiralik_isyeri.kapi_no,kiralik_isyeri.oda,kiralik_isyeri.mkare,kiralik_isyeri.cephe,kiralik_isyeri.fiyat,kiralik_isyeri.sahip_isim,kiralik_isyeri.sahip_numara,kiralik_isyeri.grup,kiralik_isyeri.ekleyen,kiralik_isyeri.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from kiralik_isyeri LEFT JOIN mahalle_koy ON kiralik_isyeri.mahalle_id=mahalle_koy.MAH_ID where mahalle_id='$mahalle' and durum=1");
							}else{
								$sorgu=mysql_query("select kiralik_isyeri.id,kiralik_isyeri.mahalle_id,kiralik_isyeri.apartman,kiralik_isyeri.kat,kiralik_isyeri.kapi_no,kiralik_isyeri.oda,kiralik_isyeri.mkare,kiralik_isyeri.cephe,kiralik_isyeri.fiyat,kiralik_isyeri.sahip_isim,kiralik_isyeri.sahip_numara,kiralik_isyeri.grup,kiralik_isyeri.durum,mahalle_koy.MAH_ID,mahalle_koy.MAHALLE_ADI from kiralik_isyeri LEFT JOIN mahalle_koy ON kiralik_isyeri.mahalle_id=mahalle_koy.MAH_ID where mahalle_id='$mahalle' and durum=1 AND uye_id='".$_SESSION["uye_id"]."'");
							}		
									$sil=$_POST["sil"];
						...
						<tr>
						  ...
						  <div id="butt">
							...
							<a href="sil.php?idkiraisyeri3=<?php echo $row["id"]; ?>&mahalle=<?php echo $mahalle; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Sil </a>
						  </div>
                          </td>
