<?php 	
    ...
    header("location: login.php");
		...
		$sor=mysql_query("select * from talepler where id='$id'");
...
if($_SERVER['REQUEST_METHOD']=='POST'){	
		...
		if(isset($id)){
				$daire_ekle=mysql_query("UPDATE talepler SET
								 isim				=	'$isim',
								 soyisim			=	'$soyisim',
								 numara				=	'$numara',
								 talep				=	'$talep',
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="isim"  value="<?php echo $getir['isim'];?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="soyisim"   value="<?php echo $getir['soyisim'];?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text" name="numara"  value="<?php echo $getir['numara'];?>" class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label  class="control-label col-md-3">Talep</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea  name="talep"  rows="4" cols="50" class="form-control col-md-7 col-xs-12" ><?php echo $getir['talep'];?></textarea>
                        </div>
                      </div>
