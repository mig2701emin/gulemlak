      ...
      <div class="col-12">
        ...
        <!-- <div class="row"> -->
          <div class="custom-control custom-checkbox mb-3">
            <input type="checkbox"  class="custom-control-input" name="Perm1" id="Perm1" value="1"/>
            <label class="custom-control-label" for="Perm1">Mağaza Ayar Yönetimi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input type="checkbox"  class="custom-control-input" name="Perm2" id="Perm2" value="1"/>
            <label class="custom-control-label" for="Perm2">Mağaza Kullanıcı Yönetimi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input type="checkbox"  class="custom-control-input" name="Perm3" id="Perm3" value="1"/>
            <label class="custom-control-label" for="Perm3">Mağaza İlan Yönetimi</label>
          </div>
          <div class="custom-control custom-checkbox mb-3">
            <input type="checkbox"  class="custom-control-input" name="Perm4" id="Perm4" value="1"/>
            <label class="custom-control-label" for="Perm4">Süper Yönetici</label>
          </div>
        <!-- </div> -->
      </div>
      <button class="btn btn-success" type="submit" name="submit">Kullanıcıyı Ekle</button>
    </div>
  </form>
</div>
