...
<div class="siteContent" style="width:1200px;">
  ...
  <div style="float:left;" class="listable">
    ...
    <form name="form81" class="mega_size_fields" action="" method="post" enctype="multipart/form-data">
      <dt>E-Posta :</dt>
      <dd><input type="email" name="email"></dd>
      <div style="clear:both"></div>
      <dt>Kullanıcı Yetkileri :</dt>
      <dd>
        <input type="checkbox" name="Perm1" id="Perm1" value="1"><label for="Perm1">Mağaza Ayar Yönetimi</label>
        <br>
      ...
      <div style="clear:both"></div>
      <input type="submit" name="submit" value="Kullanıcıyı Ekle" class="v4_special_button" style="margin-left:165px;">
    </div>
  </form>
</div>
<div style="clear:both"></div>
