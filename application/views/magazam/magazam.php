...
<div class="siteContent" style="width:1200px;">
  ...
  <div style="float:left;" class="listable">
      ...
      $("#form1").validate({
        rules:{
          'username': {
            ...
            maxlength:30,
            remote: {
              url:"http://www.ticaretmeclisi.com/check_store_username.php"
            }
          },
          'magazaadi': {
            required:true,
        ...
        messages: {
          username: {
            remote: "Kullanıcı adı kullanılmaktadır."
          }
        }
      });
    });
    ...
    <form id="form1" class="mega_size_fields" action="" method="post" enctype="multipart/form-data">
      ...
      <dd><input name="username" type="text" value="<?php echo $magaza->username; ?>" class="validate[required,maxSize[30],ajax[checkUsername]]"></dd>
      <div style="clear:both"></div>
      <dt>Mağaza Adı :</dt>
      <dd><input name="magazaadi" type="text" value="<?php echo $magaza->magazaadi; ?>"></dd>
      <div style="clear:both"></div>
      <dt>Mağaza Açıklaması :</dt>
      <dd><textarea name="m_aciklama" style="width:185px;height:135px"><?php echo base64_decode($magaza->aciklama); ?></textarea></dd>
      <div style="clear:both"></div>
      <dt>Mağaza Logosu :</dt>
      <dd><input type="file" name="image1"> (Değiştirmek İstemiyorsanız Boş Bırakınız)</dd>
      <div style="clear:both"></div>
      <dt>Mağaza Ünvanı :</dt>
      <dd><input name="unvan" type="text" value="<?php echo $magaza->unvan; ?>"></dd>
      <div style="clear:both"></div>
      <dt>Mağaza Stili :</dt>
      <dd>
        <select name="stil">
      ...
      <div style="clear:both"></div>
      <input type="submit" name="submit" value="Mağazayı Güncelle" class="v4_special_button" style="margin:0 0 5px 165px;">
    </div>
</form>
</div>
<div style="clear:both"></div>
