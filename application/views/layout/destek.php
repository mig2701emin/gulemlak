...
<head>
    ...
    <!-- Font Awesome 5 -->
    <link rel="stylesheet" href="/assets/css/pages/all.min.css">



    <!-- Theme CSS -->
    <link rel="stylesheet" href="/assets/css/pages/theme.min.css">
                    ...
                    <ul class="nav">
                        <li class="nav-item dropdown ml-lg-2 dropdown-animate" data-toggle="hover">
                            <a class="nav-link px-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img alt="Image placeholder" src="/assets/images/pages/us.svg">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-arrow">
                                <a href="" class="dropdown-item">
                                    <img alt="Image placeholder" src="/assets/images/pages/es.svg">Spanish</a>
                                <a href="" class="dropdown-item">
                                    <img alt="Image placeholder" src="/assets/images/pages/ro.svg">Romanian</a>
                                <a href="" class="dropdown-item">
                                    <img alt="Image placeholder" src="/assets/images/pages/gr.svg">Greek</a>
                            </div>
                        </li>
                    </ul>
                </div>-->
    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-sticky navbar-dark bg-dark" id="navbar-main">
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="/">
                <img alt="Image placeholder" src="/assets/images/pages/white.png" style="height: 50px;">
            </a>
                ...
                <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                    ...
                    <li class="nav-item mr-0">
                       ...
                       <!-- <a href="https://themes.getbootstrap.com/product/purpose-website-ui-kit/" target="_blank" class="btn btn-sm btn-white btn-circle btn-icon d-none d-lg-inline-flex">
                            ...
                            <span class="btn-inner--text">40% OFF: Buy now</span>
                        </a>-->
                    </li>
                </ul>
    ...
    <section class="slice slice-lg" id="sct-faq">
        <div class="container">
            <div class="row row-grid">
                <div class="col-lg-3">
                    <div class="card" data-toggle="sticky" data-sticky-offset="100">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="#section_2" data-scroll-to data-scroll-to-offset="50" class="list-group-item list-group-item-action d-flex justify-content-between">
                                <div>
                                    ...
                                    <span>Mağaza Paketleri</span>
                                </div>
                                <div>
                                    <i class="fas fa-angle-right"></i>
                                </div>
                            </a>
                            <a href="#section_3" data-scroll-to data-scroll-to-offset="50" class="list-group-item list-group-item-action d-flex justify-content-between">
                                <div>
                                    <i class="fas fa-braille"></i>
                                    <span>Mağaza Türleri</span>
                                </div>
                                <div>
                                    <i class="fas fa-angle-right"></i>
                                </div>
                ...
                <div class="col-lg-8 ml-lg-auto">
                    <div class="mb-md">
                        <h4 class="mb-4" id="section_1">Mağaza Açmak İstiyorum</h4>
                        <div class="py-4 border-bottom">
                            <h5 class="mb-3">Q: How to get started with Purpose?</h5>
                            <p class=" mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                                make a type specimen book.</p>
                        </div>
                        <div class="py-4 border-bottom">
                            <h5 class="mb-3">Q: How can I start a new project using this theme?</h5>
                            <p class=" mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                        ...
                        <div class="py-4 border-bottom">
                            <h5 class="mb-3">Q: How can I create custom user files?</h5>
                            <p class=" mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                                make a type specimen book.</p>
                        </div>
                        <div class="text-right py-4">
                            <a href="#section_1" data-scroll-to data-scroll-to-offset="50" class="text-dark text-sm font-weight-bold">Back to top<i class="far fa-long-arrow-alt-up ml-2"></i></a>
                        </div>
                    </div>
                    <div class="mb-md">
                        <h4 class="mb-4" id="section_2">Mağaza Paketleri </h4>
                        <div class="py-4 border-bottom">
                            <h5 class="mb-3">Q: How to get started with Purpose?</h5>
                            <p class=" mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                                make a type specimen book.</p>
                    ...
                    <div class="mb-md">
                        <h4 class="mb-4" id="section_3">Fonts and colors</h4>
                        <div class="py-4 border-bottom">
                            <h5 class="mb-3">Q: How to get started with Purpose?</h5>
                            <p class=" mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to
                                make a type specimen book.</p>
...
<script src="/assets/js/pages/in-view.min.js"></script>




<!-- Page plugins -->
<script src="/assets/js/pages/sticky-kit.min.js"></script>





<script src="/assets/js/pages/theme.min.js"></script>
