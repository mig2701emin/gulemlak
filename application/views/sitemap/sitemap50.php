...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <?php
    $il=$this->db->query("select il_id, il_ad, seo_il from tbl_il where il_id=47")->row();
    $ilceler=$this->db->query("select ilce_id, ilce_ad, seo_ilce from tbl_ilce where il_id=47")->result();
