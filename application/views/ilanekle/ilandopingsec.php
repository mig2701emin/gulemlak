		...
		<div class="container" style="margin-top: 50px; margin-bottom: 100px;">
			...
			<form class="form" action="" method="post">
					...
					<input type="hidden" name="gizli" value="1">
						<div class="col-md-12">
                            ...
                            <div class="row">
                                            ...
                                            Doping alın, ilanınız 10 kata kadar daha fazla görüntülensin.
                                            </span>
                                                    </div>
                                                    <div class="row  align-items-center">
                                                        <div class="col">
                                                            <div id="m_chart_profit_share" class="m-widget14__chart" style="height: 160px">
                                                                ...
                                                                <svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct" width="100%" height="100%" class="ct-chart-donut" style="width: 100%; height: 100%;"><g class="ct-series custom"><path d="M144.79,108.314A66.5,66.5,0,0,0,84.619,13.5" class="ct-slice-donut" ct:value="32" ct:meta="{&amp;quot;data&amp;quot;:{&amp;quot;color&amp;quot;:&amp;quot;#716aca&amp;quot;}}" style="stroke-width: 17px;" stroke-dasharray="133.70703125px 133.70703125px" stroke-dashoffset="-133.70703125px" stroke="#716aca"><animate attributeName="stroke-dashoffset" id="anim0" dur="1000ms" from="-133.70703125px" to="0px" fill="freeze" stroke="#716aca" calcMode="spline" keySplines="0.23 1 0.32 1" keyTimes="0;1"></animate></path></g><g class="ct-series custom"><path d="M33.38,122.389A66.5,66.5,0,0,0,144.888,108.104" class="ct-slice-donut" ct:value="32" ct:meta="{&amp;quot;data&amp;quot;:{&amp;quot;color&amp;quot;:&amp;quot;#00c5dc&amp;quot;}}" style="stroke-width: 17px;" stroke-dasharray="133.93869018554688px 133.93869018554688px" stroke-dashoffset="-133.93869018554688px" stroke="#00c5dc"><animate attributeName="stroke-dashoffset" id="anim1" dur="1000ms" from="-133.93869018554688px" to="0px" fill="freeze" stroke="#00c5dc" begin="anim0.end" calcMode="spline" keySplines="0.23 1 0.32 1" keyTimes="0;1"></animate></path></g><g class="ct-series custom"><path d="M84.619,13.5A66.5,66.5,0,0,0,33.528,122.567" class="ct-slice-donut" ct:value="36" ct:meta="{&amp;quot;data&amp;quot;:{&amp;quot;color&amp;quot;:&amp;quot;#ffb822&amp;quot;}}" style="stroke-width: 17px;" stroke-dasharray="150.65414428710938px 150.65414428710938px" stroke-dashoffset="-150.65414428710938px" stroke="#ffb822"><animate attributeName="stroke-dashoffset" id="anim2" dur="1000ms" from="-150.65414428710938px" to="0px" fill="freeze" stroke="#ffb822" begin="anim1.end" calcMode="spline" keySplines="0.23 1 0.32 1" keyTimes="0;1"></animate></path></g></svg></div>
                                                        </div>
                                                        <div class="col">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="/assets/images/doping.svg">
                                </div>
                                <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6"   style="float: left"><button type="submit" class="btn btn-primary btn-block w-75">Devam Et <i class="fas fa-caret-right"></i> </button></div>
                </div>
