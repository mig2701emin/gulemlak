                                    ...
                                    <div class="m-portlet__body" style="border-right: 1px solid white">
                                        ...
                                        <div class="m-widget7 m-widget7--skin-dark">
                                            <div class="m-widget7__desc">
                                                ...
                                                <?php }?>
                                                <br>
                                                <div class="ad_post_icons post_icon_valid">İlanınızla ilgili durumu <br>
                                                    <a  class="btn  btn-block w-100 " style="background:transparent;font-size: 1.3rem; " href="index.php?page=banaozel&type=ilan">İlanlarım</a>
                                             bölümünden takip edebilirsiniz.</div>  <br>

                                                <div class="m-widget7__button">
                                                    <a class="m-btn m-btn--pill btn btn-danger" href="#" role="button">İlanı incele</a>
                                                </div>
                                            <b> <div class="ad_id_box">İlan no :<?php echo $ilanId; ?></b></div>
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="m-widget7 m-widget7--skin-dark">
                                            <div class="m-widget7__desc">
                                                ...
                                                <div><p style="text-align:center">İlan değerlendirme süreci en fazla 6 saat sürmektedir.<br><br> Değerlendirme süreci sonunda ticaretmeclisi.com ilan yayınlama kriterlerine uygun bulunan ilanlar yayına alınacaktır.</p></div>


                                                <div class="m-widget7__button">
                                                    <a class="m-btn m-btn--pill btn btn-danger" href="#" role="button">Hesabım</a>
                                                </div>
...
<br><br><br><br>
                                            ...
                                            <div class="m-widget19__action">
                                                <button type="button" class="btn m-btn--pill btn-secondary m-btn m-btn--hover-brand m-btn--custom">Doping Satın Al</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
