...
<head>
  ...
  <script> (function(i,s,o,g,r,a,m){
    i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){ (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
     ...
     'https://www.google-analytics.com/analytics.js','ga'); ga('create', 'UA-118089649-2', 'auto'); ga('send', 'pageview');
   </script>
</head>
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
  <style>#uiv {color:#ed1c24;
...
<div class="siteContent">
      ...
      <div style="width:950px; height:50px;">
        <div style="float:left">
            <a href="http://www.ticaretmeclisi.com">
              <img id="logouiv" src="http://www.ticaretmeclisi.com/images/logo.png" alt="ticaretmeclisi.com" title="ticaretmeclisi.com" >
            </a>
          </div>
          <a style="margin-left: 250px; padding-top: 22px; position: absolute; color: #fff; font-size:16px;" href="http://www.ticaretmeclisi.com/index.php?page=ilanara">Detaylı Arama</a>
          <div style="float:right"><div class="login_bar">
            <a href="http://www.ticaretmeclisi.com/uyekayit.html" style="color:white;"><i class="fa fa-user" ></i> Üye Ol</a>
            <a href="http://www.ticaretmeclisi.com/uyegirisi.html" style="color:white;"><i class="fa fa-sign-in"></i> Giriş Yap</a>
            <a id="uiv" href="http://www.ticaretmeclisi.com/ilanekle.html"><i class="fa fa-plus"></i> ÜCRETSİZ İLAN VER</a>
          </div>
          <div style="clear:both"></div>
        </div>
        <div style="clear:both"></div>
        <form action="http://ticaretmeclisi.com/index.php" method="get" name="form9" id="form9">
          <a href="http://ticaretmeclisi.com/index.php?page=ilanara" style="position:absolute;margin-left:680px;margin-top:11px;font-size:11pt;color:#fff;"></a>
          <input type="hidden" id="page" name="page" value="ara">
          <input name="search" type="text" id="search"
            style="position:absolute;margin-top:-43px;
                  margin-left:255px;width:235px;height:35px;font-family:Segoe UI;
                  font-size:10pt;color:#2f2f2f;font-color;border:1px solid #C0C0C0;
                  background-repeat:repeat-x;-webkit-border-radius:6px;-moz-border-radius:6px;
                  border-radius:3px; font-size: 11px; font-family: arial;" placeholder="Kelime, ilan no veya mağaza adı ile ara" onFocus="this.value=''">
          <input type="submit" id="submit" name="submit" value=""
            style="position:absolute;margin-top:-42px;margin-left:452px;font-weight:bold;border:0px;
                  background-image:url(http://ticaretmeclisi.com/newbutonsearch.png);width:37px;cursor:hand;
                  cursor:pointer;height:33px;" onClick="arama();">
        </form>
      </div>
    </center>
  </div>
  ...
  $(document).ready(function(){
    var e={width:510,height:242,playButton:false,cpanelAlign:"bottomRight",borderWidth:0,delay:5000,effect:"random",tooltip:"text",shuffle:true};
...
<div class="siteContent" style="width:1200px;">
  <div style="width:150px;float:left;margin-right:15px">
    <div class="grey_border" style="width:100%;padding:3px;">
      <div class="genelbox">Özel Kategoriler</div>
      <div class="subcat_special">
        <img border="0" src="acil.png" width="16" height="15">
        <a href="http://www.ticaretmeclisi.com/acilacililanlari.html" class="cat_text">Acil Acil İlanları</a>
        <div style="clear:both"></div>
      </div>
      <div class="subcat_special">
        <img border="0" src="fiyat_etiketi.png" width="16" height="15">
        <a href="http://www.ticaretmeclisi.com/fiyatidusenler.html" class="cat_text">Fiyatı Düşenler</a>
        <div style="clear:both"></div>
      </div>
      <div class="subcat_special">
        <img border="0" src="top100.png" width="16" height="15">
        <a href="http://www.ticaretmeclisi.com/1-top100.html" class="cat_text">Top 100</a>
        <div style="clear:both"></div>
      </div>
      <div class="subcat_special">
        <img border="0" src="1ay.png" width="16" height="15">
        <a href="http://www.ticaretmeclisi.com/1-son-48saat.html" class="cat_text">Son 48 Saat</a> /
        <a href="http://www.ticaretmeclisi.com/1-son-1hafta.html" class="cat_text">1 Hafta</a> /
        <a href="http://www.ticaretmeclisi.com/1-son-1ay.html" class="cat_text">1 Ay</a>
        <div style="clear:both"></div>
      </div>
      <div class="subcat_special">
        <img border="0" src="hikayeicon.png" width="16" height="15">
        <a href="http://www.ticaretmeclisi.com/index.php?page=hikaye" class="cat_text">Hikayeni Paylaş</a>
        <div style="clear:both"></div>
      </div>
      <div class="subcat_end"></div>
      <div class="main_category">
        <img src="http://ticaretmeclisi.com/images/category_icon/emlak.png" width="20" height="20" align="left" style="margin-right:5px" alt="Emlak" title="Emlak">
        <a href="http://ticaretmeclisi.com/kategori/emlak/?kat1=45" class="cat_text">Emlak</a>
        <span style="color:#CCC;">(1465)</span>
      </div>
      <div style="clear:both"></div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/konut/?kat1=45&kat2=46" class="submenu_text">Konut</a> (908)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/_yeri/?kat1=45&kat2=47" class="submenu_text">İş Yeri</a> (58)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/arsa/?kat1=45&kat2=48" class="submenu_text">Arsa</a> (490)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/projeler.html" class="submenu_text">Projeler</a> (0)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/bina/?kat1=45&kat2=50" class="submenu_text">Bina</a> (1)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/devremlk/?kat1=45&kat2=51" class="submenu_text">Devremülk</a> (1)
      </div>
      <div class="subcat">
        <a href="http://www.ticaretmeclisi.com/kategori/turistik_tesis/?kat1=45&kat2=52" class="submenu_text">Turistik Tesis</a> (0)
      </div>
      <div class="subcat_end"></div>
    </div>
  </div>
...
<div style="float:left;" class="listable">
  <div class="genelbox">Arama Sonuçları</div>
  <table border="1" width="750" cellpadding="0" style="border-collapse: collapse;" bordercolor="#fff">
    <tr>
      <td style="background:#E9E9E9;height:35px;" width="111">&nbsp;</td>
      <td style="background:#E9E9E9;height:35px;font-weight:bold;" width="177">İlan Başlığı</td>
      <td style="background:#E9E9E9;height:35px;font-weight:bold;" width="86">Fiyat</td>
      <td style="background:#E9E9E9;height:35px;font-weight:bold;" width="104">İlan Tarihi</td>
      <td style="background:#E9E9E9;height:35px;font-weight:bold;" width="91">İl</td>
    </tr>
    <?php foreach ($ilanlar as $ilan): ?>
      <tr class="list_ads" onclick="window.location='<?php echo base_url().$ilan->seo_url; ?>.-<?php echo $ilan->Id; ?>';">
        <td width="111"><img src = "http://www.ticaretmeclisi.com/images/ad_photo.png" height = "75" width="100" border = "0" alt="denemeücretli" title="denemeücretli"></td>
        <td width="177"><a href="javascript:void(0);"><?php echo $ilan->firma_adi; ?></a></td>
        <td width="86"><?php echo $ilan->fiyat; ?>,<sup><?php echo $ilan->fiyat2; ?></sup> <?php echo $ilan->birim; ?></td>
        <td width="104"><?php echo $ilan->kayit_tarihi; ?></td>
        <td width="91"><?php echo replace("tbl_il","il_ad","il_id",$ilan->il); ?><br><?php echo replace("tbl_ilce","ilce_ad","ilce_id",$ilan->ilce); ?></td>
      </tr>
    <?php endforeach; ?>
  </table>
...
<div class="footer2">
    ...
    <ul class="footerSections">
      <li class="footerSection">
        <ul class="footerLinks">
          <li><a href="http://www.ticaretmeclisi.com/index.php?page=sayfa&sayfa=hakkimizda" style="color:#fff">Hakkımızda</a></li>
          <li><a href="http://www.ticaretmeclisi.com/index.php?page=sayfa&sayfa=yardim&kategori=iletisim" style="color:#fff">İletişim</a></li>
          <li><a href="http://www.ticaretmeclisi.com/index.php?page=destek" style="color:#fff">Destek</a></li>
        </ul>
      </li>
      <li class="footerSection">
        <ul class="footerLinks">
          <li><a href="http://www.ticaretmeclisi.com/index.php?page=sayfa&sayfa=doping" style="color:#fff">Doping</a></li>
          <li><a href="http://www.ticaretmeclisi.com/index.php?page=sayfa&sayfa=reklam" style="color:#fff">Reklam</a></li>
        </ul>
      </li>
      <li class="footerSection">
        <ul class="footerLinks">
  ...
  <div class="footer_copyright">Copyright 2018 ticaretmeclisi.com Tüm Hakları Saklıdır
    <div style="clear:both"></div>
  </div>
</div>
<script>
  function mesaj_gonder (uyeid,ilanid){
    alert('Mesaj gönderebilmek için giriş yapmalısınız.');
  }
  function favori (){
    alert('İlanı favorilerinize eklemeniz için üye girişi yapmanız gerekmektedir.');
  }
  function favorisil (){
    alert('İlanı favorilerden silebilmek için üye girişi yapmanız gerekmektedir.');
  }
</script>
