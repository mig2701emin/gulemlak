									...
									<ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm" role="tablist">
											<li class="nav-item m-tabs__item">
												<label class="radyocontainer">Hiçbiri
													<input type="radio"  name="mdoping_<?php echo $d; ?>" value="0" checked="checked">
										...
										<li class="nav-item m-tabs__item">
											<label class="radyocontainer"><?php echo $i ?> Ay ( <?php echo $magaza_doping->ucret*$i; ?> TL )
												<input type="radio" name="mdoping_<?php echo $d; ?>" id="mdoping_<?php echo $d; ?>Radio<?php echo $i ?>" value="<?php echo $i; ?>">
												<span class="checkmark"></span>
											</label>
										</li>
										<?php } ?>
