...
*/
$config['facebook_app_id']              = '242470249786569';
$config['facebook_app_secret']          = 'ecfb7ed41280ac083576fbc6d650e114';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'user_authentication';
$config['facebook_logout_redirect_url'] = 'member/login/logout';
