...
function call_fields($field_main_Id,$fieldId,$name,$type,$values,$between,$multiple,$multiple_field_name,$multiple_field_seo_name,$required,$arama,$withfilter,$showlist,$action)
{
  ...
  if($action=='withfilter'){
    ...
    if($type=='text'){
      if($between=='1'){
        $field_posted_data[$fieldId."_1"]=guvenlik($_GET[$fieldId."_1"]);
        $field_posted_data[$fieldId."_2"]=guvenlik($_GET[$fieldId."_2"]);
        ...
        $field_posted_data[$fieldId]=guvenlik($_GET[$fieldId]);
    ...
    if($type=='checkbox'){
      ...
      if($type=='text'){
        if($between=='1'){
          $field_current_date=guvenlik($_GET[$fieldId."_1"]);
          $field_current_date2=guvenlik($_GET[$fieldId."_2"]);
          ?>
          ...
          $field_current_date=guvenlik($_GET[$fieldId]);
          ?>
        ...
        <?php $field_current_date=guvenlik($_GET[$fieldId]);
        $new_values=explode("||",$values);
        for ($i = 0; $i <= count($new_values)-1; $i++) {
          ?>
    ...
    if($type=='checkbox'){
      if($action=='show'){
        ...
        $check_values=guvenlik(implode("||",$_POST[$fieldId]));
      }
      ...
      if($action=='show'){
        ...
        $change_value=guvenlik($_POST[$fieldId]);
        $change_value2=guvenlik($_POST[$multiple_field_seo_name]);
      }
    ...
    if($type=='checkbox'){
      $field_values[$fieldId]=guvenlik(implode($_POST[$fieldId],", "));
    }elseif($type=='multiple_select'){
      $field_values[$fieldId]=guvenlik($_POST[$fieldId]);
      $field_values[$multiple_field_seo_name]=guvenlik($_POST[$multiple_field_seo_name]);
    }else{
      $field_values[$fieldId]=guvenlik($_POST[$fieldId]);
    }
    ...
    if($type=='text'){
      ...
      for ($i = 0; $i <= count($new_values)-1; $i++) {
        ...
        <li style="float:left;line-height:25px;list-style-type:none;width:25%">
          ...
          <?php if($required==1){?> required<?php }if(in_array($new_values[$i],$explode_check) and $action=='edit'){?> checked<?php }?>>
