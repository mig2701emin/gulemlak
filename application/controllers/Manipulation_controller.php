...
// Perform manipuation on image ("crop","resize","rotate","watermark".)
  public function value() {
    if ($this->input->post("submit")) {
      ...
      $config = array(
        'upload_path' => "ilanlar/uploads/",
        'upload_url' => base_url() . "ilanlar/uploads/",
  ...
  public function resize($image_data) {
    ...
    $config['new_image'] = './ilanlar/uploads/new_' . $img;
...
// Rotate Manipulation.
  public function rotate($image_data) {
    ...
    $config['quality'] = "90%";
    $config['new_image'] = './ilanlar/uploads/rot_' . $img;
  ...
  public function water_marking($image_data) {
    ...
    $config['new_image'] = './ilanlar/uploads/watermark_' . $img;
  ...
  public function crop($image_data) {
    ...
    $config['new_image'] = './ilanlar/uploads/crop_' . $img;
