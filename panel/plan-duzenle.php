...
$baslik=(!empty($baslik_p)?$baslik_p:$plan['baslik']);			
$url=seo($baslik);																									
$konutsekli_p=guvenlik($_POST['konutsekli']);	
$konutsekli=(!empty($konutsekli_p)?$konutsekli_p:$plan['konutsekli']);																													
$m2_p=guvenlik($_POST['m2']);	
$m2=(!empty($m2_p)?$m2_p:$plan['m2']);																													
$odasayisi_p=guvenlik($_POST['odasayisi']);		
$odasayisi=(!empty($odasayisi_p)?$odasayisi_p:$plan['odasayisi']);																												
$banyosayisi_p=guvenlik($_POST['banyosayisi']);	
$banyosayisi=(!empty($banyosayisi_p)?$banyosayisi_p:$plan['banyosayisi']);		
$salonsayisi_p=guvenlik($_POST['salonsayisi']);	
$salonsayisi=(!empty($salonsayisi_p)?$salonsayisi_p:$plan['salonsayisi']);			
$genelozellikler_p=guvenlik(implode(",",$_POST['genelozellikler']));
$genelozellikler=(!empty($genelozellikler_p)?$genelozellikler_p:$plan['genelozellikler']);		
...
$yeni_isim="../projeler/planlar/".($Id+1);
$img_genislik="600";
$img_yukseklik="450";
include("class.image_upload.php");
$resim=",resim='".str_replace("../projeler/planlar/","",$DestinationFile).".".$fileType."'";												
}
process_mysql("update proje_planlari set baslik='$baslik',seo_url='$url',konutsekli='$konutsekli',m2='$m2',odasayisi='$odasayisi',banyosayisi='$banyosayisi',salonsayisi='$salonsayisi',genelozellikler='$genelozellikler'".$resim." where Id='".$Id."'","plan-yonetimi.html?projeId=".$plan[projeId]);
}
?>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Plan Düzenle</h2>
						<div class="box-icon">
...
<fieldset>
<legend>Plan Düzenle : <?=$plan[baslik];?></legend>
