...
<?
if($action=='sil'){
process_mysql("delete from acilacilvitrin where ilanId='".$Id."'","acil-acil-yonetimi.html");
}
?>
<form action="acil-acil-yonetimi.html" method="get" style="float:left">
...
<form action="acil-acil-yonetimi.html" method="get" style="float:right">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Acil Acil İlanları</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable dataTable">
						  ...
						  $SQL=$mysqli->query("select *,acilacilvitrin.bitis_tarihi as yeni_bitis from acilacilvitrin join firmalar on firmalar.Id=acilacilvitrin.ilanId ".$where.$order);
		...
		$durum="Aktif";
						  ...
						  ?>
							<tr class="dataListClass">
								...
								<td class="center">
									<a class="btn btn-danger" href="ilan-doping-duzenle.html?Id=<?=$ilan[Id];?>&type=acilacilvitrin">
										<i class="icon-edit icon-white"></i>  
										Düzenle                                            
									</a>
									<a class="btn btn-warning" href="acil-acil-yonetimi.html?Id=<?=$ilan[Id];?>&action=sil" onclick="confirm_delete();">
