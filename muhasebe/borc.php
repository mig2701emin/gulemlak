...
<?php
if($_POST){
	if(!empty($_POST["bt1"])){//Borç Düzenle butonu
		$id=$_POST["id"];
		$sqls="select * from borc where id=$id";
...
<form id="form1" name="form1" method="post" action="borckayit.php"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">BORÇ</td>
    </tr>
    <tr>
...
?>
<form id="form1" name="form1" method="post" action="borckayit.php">
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">BORÇ</td>
    </tr>
