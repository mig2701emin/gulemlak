 ...
 <table width="900" border="1" align="center"bgcolor="#FFF0EC">
  ...
  <tr>
    ...
    <td colspan="3"><span id="sprytextarea3">
      ...
      <textarea name="adres1" id="adres1" cols="45" rows="5"></textarea>
</span></td>
    <td colspan="3">ADRES</td>
    <td colspan="3"><span id="sprytextarea4">
      <label for="adres2"></label>
      <textarea name="adres2" id="adres2" cols="45" rows="5"></textarea>
</span></td>
    </tr>
  <tr>
    ...
    <td colspan="3"><span id="sprytextarea6">
      ...
      <textarea name="iban" id="iban" cols="45" rows="5"></textarea>
</span></td>
    <td colspan="3">İŞ ADRESİ</td>
    <td colspan="3"><span id="sprytextarea5">
      <label for="adres3"></label>
      <textarea name="adres3" id="adres3" cols="45" rows="5"></textarea>
</span></td>
  </tr>
  <tr>
    ...
    <input type="text" name="aylik1" id="aylik1" />
  ...
  <tr>
    ...
    <input type="text" name="yillik1" id="yillik1" />
<span class="textfieldInvalidFormatMsg">Sayı Giriniz.</span></span></td>
    <td colspan="3"><span id="sprytextfield11">
      ...
      <input type="text" name="yillik2" id="yillik2" />
</span></td>
  </tr>
  <tr>
    ...
    <td colspan="3"><span id="sprytextfield12">
      ...
      <input type="text" name="sekil" id="sekil" />
  ...
  <tr>
    ...
    <td colspan="3"><span id="sprytextfield17">
      ...
      <input type="text" name="depozito" id="depozito" />
  </span></td>
  ...
  <tr>
    ...
    <td colspan="3"><span id="sprytextfield13">
      ...
      <input type="text" name="muddet" id="muddet" />
    ...
    <td colspan="3"><span id="sprytextfield15">
      ...
      <input type="text" name="suan" id="suan" />
  </span></td>
  </tr>
  <tr>
    ...
    <td colspan="3"><span id="sprytextfield14">
      ...
      <input type="text" name="basi" id="basi" />
    ...
    <td colspan="3"><span id="sprytextfield16">
      ...
      <input type="text" name="neicin" id="neicin" />
</span></td>
    </tr>
  <tr>
