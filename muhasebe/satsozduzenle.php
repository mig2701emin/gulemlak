...
<?php
if(!empty($_POST["bt5"])){//Tahsilat Düzenle butonu
		echo $id=$_POST["id"];
...
<form id="form1" name="form1" method="post" action="yenisatissozlesmekayit.php">
 <table width="900" border="1" align="center"bgcolor="#FFF0EC">
  ...
  <tr>
    <td colspan="6">SATILACAK GAYRİMENKULÜN</td>
    <td width="170">&nbsp;</td>
    <td width="170"></td>
    <td colspan="2"></td>
    <td width="170">&nbsp;</td>
  ...
  <tr>
    <td width="80">CİNSİ</td>
    <td width="200" colspan="3"><span id="sprytextfield4">
  ...
  <tr>
    <td colspan="2">TAPU BİLGİLERİ </td>
    <td colspan="2">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
    <td colspan="3">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      <label for="ada"></label>
      <input type="text" name="ada" id="ada" value="<?php echo $degers["ada"]; ?>" />
</span></td>
    <td colspan="1">PAFTA</td>
    <td colspan="2"><span id="sprytextfield3">
      <label for="pafta"></label>
      <input type="text" name="pafta" id="pafta" value="<?php echo $degers["pafta"]; ?>" />
</span></td>
    <td colspan="3">PARSEL</td>
    <td colspan="2"><span id="sprytextfield2">
      <label for="parsel"></label>
      <input type="text" name="parsel" id="parsel" value="<?php echo $degers["parsel"]; ?>" />
    </span></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <input type="text" name="bedel" id="bedel" value="<?php echo $degers["bedel"]; ?>" />
  ...
  <tr>
    ...
    <input type="text" name="pesinat" id="pesinat" value="<?php echo $degers["pesinat"]; ?>" />
  ...
  <tr>
    <td colspan="11" align="center"><input type="submit" name="btup" id="btup" value="Sözleşmeyi Güncelle" /></td>
  </tr>
</table>
