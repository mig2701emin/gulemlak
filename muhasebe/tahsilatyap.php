...
<?php
if($_POST){
	if(!empty($_POST["bt1"])){//Tahsilat Düzenle butonu
		$id=$_POST["id"];
		$sqls="select * from tahsilat where id=$id";
...
<form id="form1" name="form1" method="post" action="tahsilatyapkayit.php"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">TAHSİLAT</td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td><span id="sprytextfield2">
        <label for="tahturu"></label>
        <input type="text" name="tahturu" id="tahturu" value="<?php echo $degers["tahturu"]; ?>" />
</span></td>
    </tr>
    <tr>
      <td>TUTAR</td>
...
?>
<form id="form1" name="form1" method="post" action="tahsilatyapkayit.php">
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">TAHSİLAT</td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td><span id="sprytextfield2">
        <label for="tahturu"></label>
        <input type="text" name="tahturu" id="tahturu" />
</span></td>
    </tr>
    <tr>
      <td>TUTAR</td>
