...
<?php
if($_POST){
	if(!empty($_POST["bt1"])){//Ödeme Düzenle butonu
		$id=$_POST["id"];
		$sqls="select * from odeme where id=$id";
...
<form id="form1" name="form1" method="post" action="odemeyapkayit.php"><input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">ÖDEME</td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td><span id="sprytextfield2">
        ...
        <input type="text" name="odemeturu" id="odemeturu" value="<?php echo $degers["odemeturu"]; ?>" />
</span></td>
    </tr>
    <tr>
      <td>TUTAR</td>
...
<form id="form1" name="form1" method="post" action="odemeyapkayit.php">
  <table width="600" border="0" align="center" bgcolor="#FFF0EC">
    <tr>
      <td colspan="2" align="center" valign="middle">ÖDEME</td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td><span id="sprytextfield2">
        <label for="tahturu"></label>
        <input type="text" name="odemeturu" id="odemeturu" />
</span></td>
    </tr>
    <tr>
      <td>TUTAR</td>
